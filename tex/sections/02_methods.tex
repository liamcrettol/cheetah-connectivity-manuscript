...
What the resistance map means: each cell received a number describing how difficult
the landscape was assumed to be for cheetah movement. Higher numbers mean more
difficult movement; they do not mean that movement was observed there.
What went into the final balanced map: human pressure received 60 percent of the
weight, vegetation 20 percent, and terrain 20 percent. Within human pressure, built-up
land, roads, and livestock each received 30 percent, while nighttime lights received
10 percent. Fence cells then increased the combined resistance by a multiplier from
1 to 25.
What was tested: vegetation-low used 70/10/20 percent for human pressure, vegetation,
and terrain; balanced used 60/20/20; vegetation-high used 40/40/20.
What must be explained: the scenarios that were actually run do not match the original
RES-01 to RES-06 labels exactly. Describe the completed scenarios rather than using an
incorrect count. Cite \textcite{zeller2012resistance} when explaining why the way a
variable is converted to resistance can matter as much as its weight.}
