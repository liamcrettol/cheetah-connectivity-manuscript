...
1,012 pair comparisons, with no failures. Reference Figure~\ref{fig:current2024}
for the 2024 modeled-current output, not for the input resistance surface.
