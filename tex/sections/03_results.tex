...
country. Use Figure~\ref{fig:change}.}
...
\TODO{PLAIN-LANGUAGE WRITING GUIDE.
What happened: 32 of the 45 selected links stayed important enough under the tested
assumptions to remain in the main priority group. The other 13 links were kept as
...
ranking should be presented as certain.}
...
\TODO{PLAIN-LANGUAGE WRITING GUIDE FOR MONITORING.
The planned score that would rank individual 10-km cells was not built. The completed
monitoring output is simpler: 32 links form the main priority group, while 13 uncertain
links identify places where surveys could reduce uncertainty. State this change from
the original plan instead of implying that a cell-level ranking exists.}
