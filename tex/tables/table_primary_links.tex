...
\bottomrule
\end{tabular}}
\parbox{\textwidth}{\footnotesize\emph{Notes:} The table shows the ten highest-ranked members of the 32-link primary-priority set; links are modeled structural network relationships, not observed animal routes. KNN = $k$-nearest-neighbor link; MST = minimum spanning tree link. ``KNN+MST'' identifies links retained by both network-construction rules.}
